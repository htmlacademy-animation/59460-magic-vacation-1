...
class FullPageScroll {
  constructor() {
    ...
    this.resultLink = document.querySelector(`.rules__link`);
  ...
  changeVisibilityDisplay() {
    const addActiveScreen = () => {
      ...
      if (this.resultLink) {
        this.resultLink.classList.remove(`rules__link--active`);
      }
    };
    if (this.screenElements[this.activeScreen].classList.contains(`screen--prizes`)) {
      document.body.classList.add(`backgroun-active`);
      setTimeout(addActiveScreen, 400);
    } else {
      document.body.classList.remove(`backgroun-active`);
      addActiveScreen();
    }
  }
...
/***/ "./source/js/modules/init-page.js":
/*!****************************************!*\
  !*** ./source/js/modules/init-page.js ***!
  \****************************************/
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  window.addEventListener(`load`, () => {
    const titleTypographyAnimation = new _typography_animation__WEBPACK_IMPORTED_MODULE_0__["TypographyAnimation"](`.intro__title`, 500, `active`, `intro__title-word`, `transform`);
    const labelTypographyAnimation = new _typography_animation__WEBPACK_IMPORTED_MODULE_0__["TypographyAnimation"](`.intro__label`, 500, `active`, `intro__label-word`, `transform`);
    setTimeout(() => {
...
/***/ "./source/js/modules/typography-animation.js":
/*!***************************************************!*\
  !*** ./source/js/modules/typography-animation.js ***!
  \***************************************************/
/*! exports provided: TypographyAnimation */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TypographyAnimation", function() { return TypographyAnimation; });
...
/* harmony import */ var _modules_init_page_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/init-page.js */ "./source/js/modules/init-page.js");
// modules
...
Object(_modules_init_page_js__WEBPACK_IMPORTED_MODULE_11__["initPage"])();
